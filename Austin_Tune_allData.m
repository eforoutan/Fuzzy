...
%%
X = data_Austin(:, 1:7);  % Inputs
Y = data_Austin(:, 8);    % Output
...
writeFIS(fisin_tn, 'Austin_exp_tuned_PS_allData.fis');

%% Save the Original (non-tunned) FIS

writeFIS(fisin, 'Austin_Exp_NonTuned.fis');
...
writetable(results_table, 'Austin_Exp_tuned_PS_Evaluation_allData.csv'); 
